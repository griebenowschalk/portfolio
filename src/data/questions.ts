export const questions = [
  {
    ...
    answer:
      "I specialize in React and Next.js for frontend development, and I'm expanding my expertise in Node.js and backend development to build full-stack applications.",
  },
  {
    question:
      "Are you comfortable building both frontend and backend applications?",
    answer:
