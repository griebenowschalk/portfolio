...
| --------------------- | ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| MONGODB_URI           | MongoDB connection string    | Valid URL. Local: `mongodb://localhost:27017/your-db`. Docker (API in container): `mongodb://mongodb:27017/your-db`. Atlas: `mongodb+srv://user:pass@cluster.mongodb.net/your-db`. If you omit the db name in the URI, MongoDB/Mongoose falls back to the default `test` database. |
